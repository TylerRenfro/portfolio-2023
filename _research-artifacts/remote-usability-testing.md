...
<div class="grid md:grid-cols-5 gap-4 mb-20">
  ...
  <div class="flex flex-row md:flex-col cols-span-1 gap-4 items-center">
    <div class="card bg-base-100 dark:bg-zinc-900 shadow-md md:mx-auto">
        <div class="card-body mx-auto">
            <svg class="h-8 w-8 md:h-12 md:w-12 fill-blue-500 dark:fill-blue-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M626-533q22.5 0 38.25-15.75T680-587q0-22.5-15.75-38.25T626-641q-22.5 0-38.25 15.75T572-587q0 22.5 15.75 38.25T626-533Zm-292 0q22.5 0 38.25-15.75T388-587q0-22.5-15.75-38.25T334-641q-22.5 0-38.25 15.75T280-587q0 22.5 15.75 38.25T334-533Zm146.174 116Q413-417 358.5-379.5T278-280h53q22-42 62.173-65t87.5-23Q528-368 567.5-344.5T630-280h52q-25-63-79.826-100-54.826-37-122-37ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-400Zm0 340q142.375 0 241.188-98.812Q820-337.625 820-480t-98.812-241.188Q622.375-820 480-820t-241.188 98.812Q140-622.375 140-480t98.812 241.188Q337.625-140 480-140Z"/></svg>
        </div>        
    </div>
  ...
  <div class="flex flex-row md:flex-col cols-span-1 gap-4 items-center">
    <div class="card bg-base-100 dark:bg-zinc-900 shadow-md md:mx-auto">
        <div class="card-body mx-auto">
            <svg class="h-8 w-8 md:h-12 md:w-12 fill-blue-500 dark:fill-blue-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M626-533q22.5 0 38.25-15.75T680-587q0-22.5-15.75-38.25T626-641q-22.5 0-38.25 15.75T572-587q0 22.5 15.75 38.25T626-533Zm-292 0q22.5 0 38.25-15.75T388-587q0-22.5-15.75-38.25T334-641q-22.5 0-38.25 15.75T280-587q0 22.5 15.75 38.25T334-533Zm146 272q66 0 121.5-35.5T682-393h-52q-23 40-63 61.5T480.5-310q-46.5 0-87-21T331-393h-53q26 61 81 96.5T480-261Zm0 181q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-400Zm0 340q142.375 0 241.188-98.812Q820-337.625 820-480t-98.812-241.188Q622.375-820 480-820t-241.188 98.812Q140-622.375 140-480t98.812 241.188Q337.625-140 480-140Z"/></svg>
        </div>        
    </div>
  ...
  <div class="flex flex-row md:flex-col cols-span-1 gap-4 items-center">
    <div class="card bg-base-100 dark:bg-zinc-900 shadow-md md:mx-auto">
        <div class="card-body mx-auto">
            <svg class="h-8 w-8 md:h-12 md:w-12 fill-blue-500 dark:fill-blue-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><<path d="M626-533q22.5 0 38.25-15.75T680-587q0-22.5-15.75-38.25T626-641q-22.5 0-38.25 15.75T572-587q0 22.5 15.75 38.25T626-533Zm-292 0q22.5 0 38.25-15.75T388-587q0-22.5-15.75-38.25T334-641q-22.5 0-38.25 15.75T280-587q0 22.5 15.75 38.25T334-533Zm20 194h253v-49H354v49ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-400Zm0 340q142.375 0 241.188-98.812Q820-337.625 820-480t-98.812-241.188Q622.375-820 480-820t-241.188 98.812Q140-622.375 140-480t98.812 241.188Q337.625-140 480-140Z"/></svg>
        </div>        
    </div>
    <p class="text-md text-center">Happy</p>
  </div>
  <div class="flex flex-row md:flex-col cols-span-1 gap-4 items-center">
    <div class="card bg-base-100 dark:bg-zinc-900 shadow-md md:mx-auto">
        <div class="card-body mx-auto">
        <svg class="h-8 w-8 md:h-12 md:w-12 fill-blue-500 dark:fill-blue-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M480-261q66 0 121.5-35.5T682-393H278q26 61 81 96.5T480-261ZM302-533l45-45 45 45 36-36-81-81-81 81 36 36Zm267 0 45-45 45 45 36-36-81-81-81 81 36 36ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-400Zm0 340q142.375 0 241.188-98.812Q820-337.625 820-480t-98.812-241.188Q622.375-820 480-820t-241.188 98.812Q140-622.375 140-480t98.812 241.188Q337.625-140 480-140Z"/></svg>            
        </div>        
    </div>
  ...
  <div class="card bg-base-100 dark:bg-zinc-900 shadow-2xl md:mx-auto mb-10 last:mb-20">
    <div class="card-body">
      <div class="flex flex-row items-center gap-4 mb-5 last:mb-20">
        ...
        <div class="flex flex-col">    
          <p class="text-xl dark:text-white mb-1">{{ participant.name }}</p>
          <div class="flex flex-row gap-2 items-center">
            {% if participant.rating == "Unhappy" %}
              <svg class="h-6 w-6 fill-orange-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M626-533q22.5 0 38.25-15.75T680-587q0-22.5-15.75-38.25T626-641q-22.5 0-38.25 15.75T572-587q0 22.5 15.75 38.25T626-533Zm-292 0q22.5 0 38.25-15.75T388-587q0-22.5-15.75-38.25T334-641q-22.5 0-38.25 15.75T280-587q0 22.5 15.75 38.25T334-533Zm146.174 116Q413-417 358.5-379.5T278-280h53q22-42 62.173-65t87.5-23Q528-368 567.5-344.5T630-280h52q-25-63-79.826-100-54.826-37-122-37ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-400Zm0 340q142.375 0 241.188-98.812Q820-337.625 820-480t-98.812-241.188Q622.375-820 480-820t-241.188 98.812Q140-622.375 140-480t98.812 241.188Q337.625-140 480-140Z"/></svg>
            {% endif %}
            {% if participant.rating == "Neutral" %}
            <svg class="h-6 w-6 fill-amber-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><<path d="M626-533q22.5 0 38.25-15.75T680-587q0-22.5-15.75-38.25T626-641q-22.5 0-38.25 15.75T572-587q0 22.5 15.75 38.25T626-533Zm-292 0q22.5 0 38.25-15.75T388-587q0-22.5-15.75-38.25T334-641q-22.5 0-38.25 15.75T280-587q0 22.5 15.75 38.25T334-533Zm20 194h253v-49H354v49ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-400Zm0 340q142.375 0 241.188-98.812Q820-337.625 820-480t-98.812-241.188Q622.375-820 480-820t-241.188 98.812Q140-622.375 140-480t98.812 241.188Q337.625-140 480-140Z"/></svg>
            {% endif%}
            {% if participant.rating == "Very Unhappy" %}
                <svg class="h-6 w-6 fill-red-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M480-80q-83 0-156-31.5t-127-86Q143-252 111.5-325T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 155.5 31.5t127 85.5q54.5 54 86 127T880-480q0 82-31.5 155t-86 127.5q-54.5 54.5-127 86T480-80Zm0-60q141 0 240.5-99.5T820-480q0-142-99.5-241T480-820q-142 0-241 99t-99 241q0 141 99 240.5T480-140Zm73-391 14-8q3 20 18 33t35 13q23 0 38.5-15.5T674-547q0-13-5.5-24T653-590l27-15-20-35-127 73 20 36Zm-146 0 20-36-127-73-20 35 27 15q-10 8-15.5 19t-5.5 24q0 23 15.5 38.5T340-493q20 0 35-13t18-33l14 8Zm73 94q-69 0-121 45.5T281-280h398q-27-65-78.5-111T480-437Zm0-43Z"/></svg>
            {% endif %}
            <p class="text-md">{{ participant.rating }}</p>
          </div>
        </div>
      </div>    
      <p class="text-xl mb-10 basis-1/2">"{{ participant.ratingAnswer }}"</p>
      <hr class="mb-10 dark:border-base-100">
      <div class="flex flex-col md:flex-row gap-4 mb-5">
        <p class="text-md w-full md:w-1/2 text-zinc-500">How confident are you in […]'s capabilities to support many new provider locations and accounts?</p>
        <div class="flex flex-row text-md basis-full md:basis-1/2 items-center gap-2">
          <div>
            <p class="text-md pt-1">{{ participant.additionalAnswer1 }}</p>
          </div>
          {% if participant.additionalAnswer1 == "1/5" %}
      ...
      <div class="flex flex-col md:flex-row gap-4">
        <p class="text-md basis-full md:basis-1/2 text-zinc-500">Tell us more about why you chose that rating.</p>
        <p class="text-md basis-full md:basis-1/2">{{ participant.additionalAnswer2 }}</p>
      </div>
    </div>  
  </div>
  {% endfor %}
...
<div class="flex flex-row mb-10">
  <div class="flex flex-col mx-auto">
    <div class="card bg-base-100 dark:bg-zinc-900 shadow-md mb-3">
        <div class="card-body mx-auto">           
            <svg class="h-12 w-12 md:h-24 md:w-24 fill-blue-500 dark:fill-blue-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M80-120v-720h390v165h410v555H80Zm60-60h105v-105H140v105Zm0-165h105v-105H140v105Zm0-165h105v-105H140v105Zm0-165h105v-105H140v105Zm165 495h105v-105H305v105Zm0-165h105v-105H305v105Zm0-165h105v-105H305v105Zm0-165h105v-105H305v105Zm165 495h350v-435H470v105h80v60h-80v105h80v60h-80v105Zm185-270v-60h60v60h-60Zm0 165v-60h60v60h-60Z"/></svg>
        </div>        
    </div>
    <p class="text-md text-center">Providers</p>
  </div>
    <div class="flex flex-col mx-auto">
    <div class="card bg-base-100 dark:bg-zinc-900 shadow-md mb-3">
        <div class="card-body mx-auto">
          <svg class="h-12 w-12 md:h-24 md:w-24 fill-red-500 dark:fill-red-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M140-80q-24 0-42-18t-18-42v-520q0-24 18-42t42-18h180v-100q0-24 18-42t42-18h200q24 0 42 18t18 42v100h180q24 0 42 18t18 42v520q0 24-18 42t-42 18H140Zm0-60h680v-520H140v520Zm240-580h200v-100H380v100ZM140-140v-520 520Zm310-230v120h60v-120h120v-60H510v-120h-60v120H330v60h120Z"/></svg>
        </div>        
    </div>
    <p class="text-md text-center">Caregivers</p>
  </div>
    <div class="flex flex-col mx-auto">
    <div class="card bg-base-100 dark:bg-zinc-900 shadow-md mb-3">
        <div class="card-body mx-auto">
            <svg class="h-12 w-12 md:h-24 md:w-24 fill-emerald-500 dark:fill-emerald-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M140-80q-24 0-42-18t-18-42v-480q0-24 18-42t42-18h250v-140q0-24 18-42t42.411-18h59.178Q534-880 552-862t18 42v140h250q24 0 42 18t18 42v480q0 24-18 42t-42 18H140Zm0-60h680v-480H570v30q0 28-18 44t-42.411 16h-59.178Q426-530 408-546t-18-44v-30H140v480Zm92-107h239v-14q0-18-9-32t-23-19q-32-11-50-14.5t-35-3.5q-19 0-40.5 4.5T265-312q-15 5-24 19t-9 32v14Zm336-67h170v-50H568v50Zm-214-50q22.5 0 38.25-15.75T408-418q0-22.5-15.75-38.25T354-472q-22.5 0-38.25 15.75T300-418q0 22.5 15.75 38.25T354-364Zm214-63h170v-50H568v50ZM450-590h60v-230h-60v230Zm30 210Z"/></svg>
        </div>        
    </div>
    <p class="text-md text-center">Clients</p>
  </div>
</div>
